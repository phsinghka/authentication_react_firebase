...
const SignUpPage = () => {
  ...
  * Checks weather password and confirm password are same
  * Takes user object after user signs up
  * Uploads User Image and create user document reference in firestore
  */
